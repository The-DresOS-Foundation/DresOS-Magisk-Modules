...
[Download latest release](https://github.com/The-DresOS-Foundation/DresOS-Magisk-Modules/releases/tag/webview-v2.3.2)
...
| ABI | arm64 runs DresOS WebView, armeabi-v7a runs AOSmium by AXP.OS as the backup engine |
| Root | Magisk 29.0+ |
