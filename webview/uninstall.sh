#!/system/bin/sh
##############################################################################
#  DresOS WebView: uninstall.sh
#
#  Clears the saved WebView provider selection, re enables the stock WebView
#  that service.sh disabled, and plants a one-shot self-deleting trampoline as
#  a backup for recovery removals where this script never runs.
##############################################################################
