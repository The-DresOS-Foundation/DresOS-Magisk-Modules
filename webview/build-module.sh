#!/bin/sh
##############################################################################
#  DresOS WebView: module build script
#
#  Inputs (must be present before running):
#    overlay/DresOSWebViewOverlay.apk   Built by overlay/build.sh
#    apks/webview-arm64.apk             The signed DresOS WebView APK (arm64)
#    apks/aosmium-arm32.apk             The AOSmium 32-bit arm engine (armeabi-v7a)
#
#  Output:
#    DresOS-WebView-<version>.zip in the current directory
#
#  Run from the webview/ directory.
##############################################################################
